...
public class IslandHandler
{
    ...
    private static final String INSERT_ISLAND = "INSERT INTO `islands` (`owner`, `editPermission`, `visitPermission`) VALUES(?, ?, ?);";
    ...
    private static final String UPDATE_ISLAND = "UPDATE `islands` SET `editPermission`=?, `visitPermission`=? WHERE `owner`=?;";
    ...
    public void updateIsland(PlayerWorld world)
    {
        try (Connection connection = Plex.get().getSqlConnection().getCon())
        {
            ...
            statement.setString(3, world.owner().toString());
